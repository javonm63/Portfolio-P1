...
const loginPageBtnMob = document.getElementById("mobile-login-button")
const loginPageBtnWeb = document.getElementById("web-login-button")
...
loginPageBtnMob.addEventListener('click', openLoginPage)
loginPageBtnWeb.addEventListener('click', openLoginPage)
